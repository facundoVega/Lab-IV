...
class usuario
{
	...
	{
			$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
			$consulta =$objetoAccesoDato->RetornarConsulta("select id ,nombre,  tipo, estado   from usuarios");
			$consulta->execute();	
	...
	{
			$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
			$consulta =$objetoAccesoDato->RetornarConsulta("select id, nombre as nombre, tipo as tipo from usuarios where id = $id");
			$consulta->execute();
